...
/* The error occurs due to trying to reassign constant variable. */
// SCHOOL = "HerCollege"
...
// The first two concatenate due to the string
...
if (age < 13) {
    ...
    console.log("You have to enter a Valid Age")
}
...
console.log(a)
// console.log(b) b cannot be printed because it is block scoped
